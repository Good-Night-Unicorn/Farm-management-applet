<template>
    ...
    <view @tap="onDetailTap('news',item.id)" v-for="(item,index) in newsList" :key="index" class="list-item" :style='{"padding":"10rpx","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"20rpx 20rpx","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,255,255,1)","borderRadius":"20rpx","borderWidth":"2rpx","width":"auto","borderStyle":"solid","height":"auto"}' style="display: flex;">
        <view class="list-item-body" style="flex: 1;">
            ...
            <view :style='{"padding":"0 20rpx","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"10rpx 0 40rpx 0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"rgba(164, 164, 164, 1)","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"auto","fontSize":"28rpx","borderStyle":"solid"}' class="desc hide2"
                v-html="item.newsContent.length>30?item.newsContent.substr(0,30)+'...':item.newsContent">
            </view>
        ...
        <image :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(255,0,0,0)","borderRadius":"50%","borderWidth":"8rpx","width":"200rpx","borderStyle":"solid","height":"200rpx"}' mode="aspectFill" class="listmpic"
           :src="baseUrl+item.newsPhoto"></image>
    </view>
</view>
        </view>
...
<view class="list-box4"
    ...
    <block v-for="(product,index) in nongchangList" :key="index">
        <view v-if="index%6==0" @tap="onDetailTap('nongchang',product.id)" class="list-item"
            ...
            <image
                    ...
                    mode="aspectFill" :src="baseUrl+product.nongchangPhoto">
            </image>
            <view class="list-item-body" style="display: flex;flex-wrap: wrap;">
                <view
                        ...
                        class="title hide1">{{product.nongchangName}}
                </view>
            </view>
        </view>
        <view v-if="index%6==1" @tap="onDetailTap('nongchang',product.id)"
        ...
        <view v-if="index%6==2" @tap="onDetailTap('nongchang',product.id)"
        ...
        <view v-if="index%6==3" @tap="onDetailTap('nongchang',product.id)" class="list-item"
        ...
        <view v-if="index%6==4" @tap="onDetailTap('nongchang',product.id)"
        ...
        <view v-if="index%6==5" @tap="onDetailTap('nongchang',product.id)"
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let nongchang = await this.$api.requestCondition('nongchang','gexingtuijian',val);

            this.nongchangList = nongchang.data.list
            this.nongchangList.forEach(function(item, index) {
                if(item.nongchangContent != null && item.nongchangContent != "" && item.nongchangContent != "null"){
                    item.nongchangContent =item.nongchangContent.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gi,"");//替换图片
                }
            });
